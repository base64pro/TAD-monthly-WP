...
UI_TEXTS = {
    'ar': {
        ...
        'th_status': "الحالة",
        'th_programs': "البرامج", 'th_logistics': "اللوجستيين", 'th_finance': "المالية",
        ...
        'label_status': "الحالة:",
        'label_teams': "تفاصيل الفرق:", 'label_programs': "البرامج:",
        'label_logistics': "اللوجستيين:", 'label_finance': "المالية:",
        'label_media': "الميديا:", 'label_cars': "السيارات:",
        'label_publication_links': "روابط النشر (اختياري):",
        ...
        'activity_added_success': "تم إضافة النشاط بنجاح!",
        ...
        'code_incorrect': "الرمز المدخل غير صحيح.", 'editor_selected_msg': "تم اختيار المحرر",
        'invalid_editor': "المحرر المختار غير صالح.", 'invalid_editor_id': "معرف المحرر غير صالح.",
        'select_editor_warning': "الرجاء اختيار اسم المحرر.",
        'editor_mode_logout_msg': "تم الخروج من وضع التحرير.",
        'editor_required_warning': "يجب الدخول كـ محرر أو Admin واختيار اسمك للوصول لهذه الوظيفة.",
        'login_admin': "الدخول كـ Admin", 'verify_admin_code_placeholder': "أدخل رمز الـ Admin",
        ...
        'label_project_name': "اسم المشروع:", 'modal_title_add_editor': "إضافة محرر جديد",
        'modal_title_edit_editor': "تعديل محرر", 'modal_title_add_project': "إضافة مشروع جديد",
        'modal_title_edit_project': "تعديل مشروع", 'editor_added_success': "تم إضافة المحرر بنجاح.",
        'editor_updated_success': "تم تحديث المحرر بنجاح.", 'editor_deleted_success': "تم حذف المحرر بنجاح.",
        'editor_add_error': "خطأ في إضافة المحرر.", 'editor_update_error': "خطأ في تحديث المحرر.",
        'editor_delete_error': "خطأ في حذف المحرر.", 'editor_delete_confirm': "هل أنت متأكد من حذف هذا المحرر؟ ({name})",
        ...
        'project_added_success': "تم إضافة المشروع بنجاح.", 'project_updated_success': "تم تحديث المشروع بنجاح.",
        'project_deleted_success': "تم حذف المشروع بنجاح.", 'project_add_error': "خطأ في إضافة المشروع.",
        'project_update_error': "خطأ في تحديث المشروع.", 'project_delete_error': "خطأ في حذف المشروع.",
        ...
        'name_required': 'الاسم مطلوب.', 'name_unique': 'هذا الاسم مستخدم بالفعل.',
        'fetch_editors_error': 'خطأ في جلب قائمة المحررين.', 'fetch_projects_error': 'خطأ في جلب قائمة المشاريع.',
    ...
    'en': {
        ...
        'th_status': "Status",
        'th_programs': "Programs", 'th_logistics': "Logistics", 'th_finance': "Finance",
        ...
        'label_status': "Status:",
        'label_teams': "Team Details:", 'label_programs': "Programs:",
        'label_logistics': "Logistics:", 'label_finance': "Finance:",
        'label_media': "Media:", 'label_cars': "Cars:",
        'label_publication_links': "Publication Links (Optional):",
        ...
        'code_incorrect': "Incorrect code entered.", 'editor_selected_msg': "Editor selected",
        'invalid_editor': "Selected editor is invalid.", 'invalid_editor_id': "Invalid editor ID.",
        'select_editor_warning': "Please select editor name.",
        'editor_mode_logout_msg': "Logged out from editor mode.",
        'editor_required_warning': "You must be logged in as an Editor or Admin and select your name to access this function.",
        'login_admin': "Login as Admin", 'verify_admin_code_placeholder': "Enter Admin Code",
        ...
        'label_project_name': "Project Name:", 'modal_title_add_editor': "Add New Editor",
        'modal_title_edit_editor': "Edit Editor", 'modal_title_add_project': "Add New Project",
        'modal_title_edit_project': "Edit Project", 'editor_added_success': "Editor added successfully.",
        'editor_updated_success': "Editor updated successfully.", 'editor_deleted_success': "Editor deleted successfully.",
        'editor_add_error': "Error adding editor.", 'editor_update_error': "Error updating editor.",
        'editor_delete_error': "Error deleting editor.", 'editor_delete_confirm': "Are you sure you want to delete this editor? ({name})",
        ...
        'project_added_success': "Project added successfully.", 'project_updated_success': "Project updated successfully.",
        'project_deleted_success': "Project deleted successfully.", 'project_add_error': "Error adding project.",
        'project_update_error': "Error updating project.", 'project_delete_error': "Error deleting project.",
        ...
        'name_required': 'Name is required.', 'name_unique': 'This name is already in use.',
        'fetch_editors_error': 'Error fetching editor list.', 'fetch_projects_error': 'Error fetching project list.',
        'get_editor_error': 'Error fetching editor data for editing.', 'get_project_error': 'Error fetching project data for editing.',
    }
}
...
# --- تسجيل فلتر url_decode بشكل صريح ---
app.jinja_env.filters['url_decode'] = unquote

# تحديد رابط قاعدة البيانات
...
if not EDITOR_CODE:
    print("--- WARNING: EDITOR_CODE not set in environment variables or .env file.")
if not ADMIN_CODE:
    print("--- WARNING: ADMIN_CODE not set in environment variables or .env file.")
...
with app.app_context():
    ...
    try:
        ...
        if not Activity.query.first() and Project.query.first() and Editor.query.first():
            print("--- INFO: Adding initial activities...")
            default_project = Project.query.first()
            default_editor = Editor.query.first()
            project_beta = Project.query.filter_by(name="مشروع بيتا").first() or default_project
            editor_fatima = Editor.query.filter_by(name="فاطمة حسن").first() or default_editor
            ...
            a4 = Activity(activity_date=day_after_tomorrow, project_id=default_project.id, activity_desc="نشاط تجريبي لبعد غد.", location="المكتب الرئيسي", status=0, team_programs="فريق أ", last_updated_by_id=default_editor.id) # غير مؤكد

            db.session.add_all([a1, a2, a3, a4])
            db.session.commit()
            print("--- INFO: Initial activities added with new status field.")
        elif Activity.query.first():
             print("--- INFO: Activities table not empty, skipping initial activity data.")
        else:
            print("--- WARNING: Skipping initial activity creation because initial project/editor not found.")
...
def monthly_plan(lang=None, year=None, month=None):
    ...
    if lang and lang in LANGUAGES: session['lang'] = lang
    current_lang = get_locale()

    current_time = datetime.now()
    if year is None: year = current_time.year
    if month is None: month = current_time.month
    if not 1 <= month <= 12: month = current_time.month; year = current_time.year
    ...
    return render_template('index.html',
                           title=page_title, activities=activities,
                           current_year=year, current_month=month, month_name=month_name,
                           next_month_url=next_month_url, prev_month_url=prev_month_url,
                           editors=editors, projects=projects, LANGUAGES=LANGUAGES,
...
def verify_code():
    ...
    if EDITOR_CODE and entered_code == EDITOR_CODE:
        ...
        session.pop('is_editor', None); session.pop('editor_id', None); session.pop('editor_name', None)
...
def add_activity():
    ...
    try:
        ...
        try:
            ...
            original_redirect_url = url_for('monthly_plan', year=redirect_year, month=redirect_month, lang=lang)
        ...
        new_activity = Activity(
            ...
            last_updated_by_id=session.get('editor_id'), admin_suggestions=admin_suggestions
        )
...
def edit_activity(activity_id):
    ...
    try:
        ...
        activity_to_edit.activity_date = new_date
        ...
        activity_to_edit.team_media = team_media or None
        activity_to_edit.team_cars = team_cars or None
        activity_to_edit.link1 = link1 or None
        activity_to_edit.link2 = link2 or None
        activity_to_edit.link3 = link3 or None
        ...
        db.session.commit()
        flash(get_text('activity_updated_success'), 'success')
...
def get_activity_data(activity_id):
    try:
        ...
        activity_data = {
            ...
            'admin_suggestions': activity.admin_suggestions
        }
...
def edit_editor(editor_id):
    ...
    try:
        ...
        if existing:
            flash(get_text('name_unique'), 'warning'); print(f"--- ADMIN WARN: Attempted to rename editor {editor_id} to duplicate name '{new_name}'.")
            return redirect(redirect_url)
        editor_to_edit.name = new_name; db.session.commit()
        if session.get('editor_id') == editor_id:
            session['editor_name'] = new_name
            print(f"--- ADMIN: Updated session name for editor {editor_id}.")
        flash(get_text('editor_updated_success'), 'success'); print(f"--- ADMIN: Editor {editor_id} ('{original_name}') renamed to '{new_name}'.")
    except IntegrityError:
        db.session.rollback(); flash(get_text('name_unique'), 'warning'); print(f"--- ADMIN ERROR: IntegrityError renaming editor {editor_id} to '{new_name}'.")
    except Exception as e:
        db.session.rollback(); print(f"--- ERROR updating editor {editor_id}: {e}"); traceback.print_exc(); flash(get_text('editor_update_error'), 'danger')
    return redirect(redirect_url)
...
def delete_editor(editor_id):
    ...
    if session.get('editor_id') == editor_id:
        flash(get_text('editor_delete_current_error'), 'danger'); print(f"--- ADMIN WARN: Attempted to delete currently selected editor {editor_id}.")
        return redirect(redirect_url)
    if Activity.query.filter_by(last_updated_by_id=editor_id).first():
        flash(get_text('editor_delete_prevented'), 'warning'); print(f"--- ADMIN WARN: Attempted to delete editor {editor_id} with associated activities.")
        return redirect(redirect_url)
    try:
        ...
        db.session.rollback(); print(f"--- ERROR deleting editor {editor_id}: {e}"); traceback.print_exc(); flash(get_text('editor_delete_error'), 'danger')
    return redirect(redirect_url)
...
def get_editor_data(editor_id):
    try:
        ...
        return jsonify({'id': editor.id, 'name': editor.name})
    except Exception as e:
        print(f"--- ERROR fetching editor data for admin edit {editor_id}: {e}")
        traceback.print_exc()
        return jsonify({'error': get_text('get_editor_error')}), 500
...
def add_project():
    ...
    try:
        ...
        db.session.rollback(); flash(get_text('name_unique'), 'warning'); print(f"--- ADMIN WARN: Attempted to add duplicate project name '{name}'.")
    except Exception as e:
        db.session.rollback(); print(f"--- ERROR adding project: {e}"); traceback.print_exc(); flash(get_text('project_add_error'), 'danger')
    return redirect(redirect_url)
...
def edit_project(project_id):
    ...
    try:
        ...
        if existing:
            flash(get_text('name_unique'), 'warning'); print(f"--- ADMIN WARN: Attempted to rename project {project_id} to duplicate name '{new_name}'.")
            return redirect(redirect_url)
        ...
        db.session.rollback(); flash(get_text('name_unique'), 'warning'); print(f"--- ADMIN ERROR: IntegrityError renaming project {project_id} to '{new_name}'.")
    except Exception as e:
        db.session.rollback(); print(f"--- ERROR updating project {project_id}: {e}"); traceback.print_exc(); flash(get_text('project_update_error'), 'danger')
    return redirect(redirect_url)
...
def delete_project(project_id):
    ...
    if Activity.query.filter_by(project_id=project_id).first():
        flash(get_text('project_delete_prevented'), 'warning'); print(f"--- ADMIN WARN: Attempted to delete project {project_id} with associated activities.")
        return redirect(redirect_url)
    try:
        ...
        db.session.rollback(); print(f"--- ERROR deleting project {project_id}: {e}"); traceback.print_exc(); flash(get_text('project_delete_error'), 'danger')
    return redirect(redirect_url)
...
def get_project_data(project_id):
    try:
        ...
        print(f"--- ERROR fetching project data for admin edit {project_id}: {e}")
        traceback.print_exc()
...
if __name__ == '__main__':
    ...
    if not EDITOR_CODE or not ADMIN_CODE:
        print("--- WARNING: EDITOR_CODE or ADMIN_CODE is not set in environment. Login might not work.")
    ...
    print(f"--- INFO: Running Flask app locally with debug mode: {is_debug_mode} on port {port}")
